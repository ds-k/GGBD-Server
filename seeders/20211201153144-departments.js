  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert("departments", [
      ...
      },
      {
        name: "소화기내과",
        description:
          "소화기내과는 식도, 위, 십이지장, 대장, 간, 담도 및 췌장 등의 장기에 발생하는 각종 질환에 대한 진단과 치료를 시행합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        name: "감염내과",
        description:
          "감염내과는 미생물에 의해 발생하는 감염질환을 진단하고 치료하며, 타 진료과에서 발생하는 각종 감염질환 및 항생제 사용에 관한 자문을 시행합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        name: "심장혈관내과",
        description:
          "심장혈관내과는 심혈관계통의 질환을 진단하고 치료하는 내과의 한 영역으로, 고혈압, 허혈성 심장질환, 선천성 심장질환, 부정맥, 심부전증 등을 다룹니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        name: "마취통증의학과",
        description:
          "마취통증의학과는 수술을 위한 마취, 중환자관리 그리고 통증치료를 다룹니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        name: "비뇨의학과",
        description:
          "비뇨의학과는 콩팥, 요관, 방광 등 요로계 장기들과 음경, 고환, 정관 및 전립선 등 남성생식과 관련된 장기를 다루는 진료과로서 주로 수술적인 방법으로 치료합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        name: "방사선종양학과",
        description:
          "방사선종양학과는 방사선을 이용하여 질병을 치료하는 임상 진료과 입니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        name: "산부인과",
        description:
          "산부인과는 임신과 출산에 관한 질환 및 여성의 생식기관에서 발생하는 모든 질환을 전문적으로 진료합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        name: "소아청소년과",
        description:
          "소아청소년과는 임신부터 청소년기에 이르기까지 어린이의 성장과 발달을 다루는 임상분야로 그 시기의 환자를 대상으로 진료 및 치료 방법을 연구합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        name: "신경과",
        description:
          "신경과는 뇌와 척수(중추신경), 말초신경 및 근육에 발생하는 질환을 진단하고 치료하며 신경계 질환의 원인을 규명하고 더 나은 치료방법을 연구합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        name: "흉부외과",
        description:
          "흉부외과는 흉부에 위치한 심장, 폐, 식도, 대동맥, 종격동, 횡격막, 기관 등의 질환에 대한 수술적 치료를 담당합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        name: "소아외과",
        description:
          "소아외과는 태어나면서 기형이나 장애가 있거나 사고를 당해 수술이 필요한 18세 이하의 소아와 청소년을 대상으로 합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        name: "간담췌외과",
        description:
          "간담췌외과는 간, 담도, 췌장에 발생하는 수술적 치료가 요구되는 각종 양성 및 악성 질환을 진단하고 치료합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        name: "대장항문외과",
        description:
          "대장항문외과는 하부 위장관에 발생하는 다양한 질환에 대한 기초 연구와 임상 연구, 그리고 외과적 치료를 시행합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        name: "예방의학과",
        description:
          "예방의학은 건강과 관련된 위험요인의 분포를 조사하고 그들 사이의 관련성을 통해 건강을 증진하는 것을 목표로 합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        name: "정신건강의학과",
        description:
          "정신건강의학과에서는 뇌와 관련된 인간의 감정, 사고 그리고 행동 등 신경·정신기능의 문제를 진단하고 치료합니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        name: "치과",
        description:
          "치과는 턱관절, 치아 및 치아주위조직(잇몸, 잇몸뼈)과 관련된 선천적, 후천적인 질환 및 장애를 치료하는 분야입니다.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ]);
